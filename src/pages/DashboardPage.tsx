          ...
          <div className="space-y-2.5">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-800 dark:text-slate-100">Integraciones & API</p>
                  <p className="text-[11px] text-slate-400">Google Calendar, WhatsApp, Webhooks</p>
                </div>
              </div>
              <ArrowRight className="w-4 h-4 text-slate-400 group-hover:translate-x-1 transition-transform" />
            </Link>
